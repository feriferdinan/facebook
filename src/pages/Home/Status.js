        ...
        <View>
        {
          ...
          <View key={index} style={{marginTop:5,marginBottom:5}}  >
            ...
            <View style={{flex:1,flexDirection:'row',paddingHorizontal:6 , backgroundColor:'#ffffff'}}  >
              ...
              <Text style={{alignContent:'center',fontWeight:'bold',color:'black' }} >&bull;&bull;&bull;</Text>
              </View>
              </View>
              </TouchableOpacity>
            ...
            <TouchableOpacity>
              <View style={{backgroundColor:'#ffffff'}}  >
                <Text style={{flexWrap:'wrap',padding:5}} >{item.content.text}</Text>
                <Image style={{position:'absolute',maxWidth:'100%',minWidth:200}}
